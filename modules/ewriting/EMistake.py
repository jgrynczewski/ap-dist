	...
	def createGui(self):
		...
		try:
		        ...
		        self.subSizer0.Add( be, 0,wx.EXPAND )
                        ...
                        self. mainSizer.Add( self.subSizerP, proportion = 1, flag = wx.EXPAND | wx.BOTTOM, border = 3 )
                        self. mainSizer.Add( self.subSizer0, proportion = 7, flag = wx.EXPAND )
                        self. mainSizer.Add( self.subSizer, proportion = 2, flag = wx.EXPAND | wx.TOP, border = 3 )
