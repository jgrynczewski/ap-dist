...
class radio( wx.Frame ):
	...
	def initializeBitmaps(self):
		...
		try:
			self.path = self.pathToAP + 'multimedia/radio/'
			...
			for number in range( self.numberOfPanels ):
				...
				self.radioURL = []
				with open( self.pathToAP + 'documents/radio/radioURL', 'r' ) as file:
					for line in file:
